...
if($_REQUEST['Did']>0)
{
	...
	header("location:uploadmusic.php?msg=Your music has been deleted successfully.");			
	exit;
}
...
if($_POST['HidRegUser']=="1")
{
		...
		header("location:uploadmusic.php?msg=Your music has been updated successfully.");			
		exit;
}
					...
					<div class="box1" >
						<div class="" ><div class="wrapper" >
							<section class="col1_1" style="width:830px;">
								<h2><strong style="width:60px;">My</strong> Musics</h2>
								<div class="pad_bot1">
									<figure>
										<table width="100%" border="0" cellspacing="2" cellpadding="3">
										  <tr>
										  		<td align="left" style="padding:5px;">
														...
														<table width="100%" border="0" cellspacing="5" cellpadding="0">
														  <tr>
															<td width="78" align="left">Music:</td>
															<td width="232" align="left"><input type="file" name="music" id="music">&nbsp;</td>
														  ...
														  <tr>
															...
															<input type="submit" value="Upload Music" style="float:none;" class="button1"  onClick="return Proceed();" /></td>
															<td align="left" width="373"><input type="button" value="Back to Profile" style="float:none;" class="button1"  onClick="window.location.href='myaccount.php';" /></td>
														  </tr>
														</table>
														</form>
												</td>
										  ...
										  <tr>
											<td style="padding:5px;">
												<table width="100%"border="0" cellspacing="5" cellpadding="0">
												<?
													$GetTotalPictureQry="SELECT * FROM users_musics WHERE userid='".trim($_SESSION['UsErId'])."' order by id desc";
													...
													if($TotGetTotalPicture>0)
													{
														for($F=0;$F<$TotGetTotalPicture;$F++)
														{
															...
															if($F%3==0){echo "</tr><tr><td height='25'>&nbsp;</td></tr><tr>";}
															?>
															<td width="250" height="155" valign="top" >
																<table border='0' cellpadding='0' cellspacing='0'  width="250" style="background-color:#999999;" >
																  <tr>
																	<td align='center'  ><embed width="250" autostart="false" src="Musics/<? echo $GetTotalPictureQryRow['music']; ?>"> <?php /*?><? echo substr(ucfirst(stripslashes($GetTotalPictureQryRow['caption'])),0,30); ?><?php */?></td>
																  </tr>	
																  <tr>
																  ...
																  <tr>
																	<td align='center' height="25" valign="bottom" ><a  href='#' class="button1" style="float:none;font-size:11px;" onClick="javascript:document.location.href='uploadmusic.php?Did=<? echo $GetTotalPictureQryRow['id']; ?>';">Delete</a></td>
																  </tr>	
																</table>
															  </td>
															<?
