<? include("connect.php"); 
$query1="select * from users where id='".mysql_real_escape_string(trim($_REQUEST['id']))."' ";
...
<html lang="en">
<head>
<title><? echo ucfirst(stripslashes($Row['firstname']));?> <? echo ucfirst(stripslashes($Row['lastname']));?>'s Profile at <? echo $SITE_NAME;?></title>
<meta charset="utf-8">
			...
			<div class="wrapper">
				<div class="pad_left2 relative">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td align="left"><h4 class="color3"><span><? echo ucfirst(stripslashes($Row['firstname']));?> <? echo ucfirst(stripslashes($Row['lastname']));?> Profile</span></h4></td>
						<td align="right" valign="bottom">&nbsp;<a href="javascript:history.back(-1);" class="button2">Back</a></td>
					  </tr>
					</table>
