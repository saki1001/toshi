<? include("connect.php"); 
$ACTIVEPAGE='';
$Getstatic1=mysql_query("select * from staticpage where id=6");
		...
		<article id="content">
			...
			<div class="wrapper">
				<div class="pad_left2 relative">
					<h4 class="color3"><span>Jobs</span></h4>
					...
					<div class="box1" >
						<div class="" ><div class="wrapper" >
							<section class="col1_1" style="width:830px;">
								<h2><strong style="width:100px;">Jobs</strong> Listings</h2>
								<div class="pad_bot1">
									<figure>
										<table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" >	 
										<tr>
											<td align="left" style="padding:5px;"><? echo stripslashes($GetstaticRow1['content']);?>
											</td>
										</tr>		
								  		</table>
									</figure>
