...
if($_REQUEST['Did']>0)
{
	...
	header("location:uploadpics.php?msg=Your picture has been deleted successfully.");			
	exit;
}
...
if($_POST['HidRegUser']=="1")
{
		...
		header("location:uploadpics.php?msg=Your picture has been updated successfully.");			
		exit;
}
					...
					<div class="box1" >
						<div class="" ><div class="wrapper" >
							<section class="col1_1" style="width:830px;">
								<h2><strong style="width:60px;">My</strong> Pictures</h2>
								<div class="pad_bot1">
									<figure>
														...
														for($F=0;$F<$TotGetTotalPicture;$F++)
														{
															...
															<td width="145" height="155" valign="top" >
																<table border='0' cellpadding='0' cellspacing='0'  width="145" style="background-color:#999999;" >
																  ...
																  <? } ?>
																  <tr>
																	<td align='center' height="25" valign="bottom" ><a  href='#' class="button1" style="float:none;font-size:11px;" onClick="javascript:document.location.href='uploadpics.php?Did=<? echo $GetTotalPictureQryRow['id']; ?>';">Delete</a></td>
																  </tr>	
																</table>
															  </td>
															<?
