										  ...
										  <tr>
											...
											<td width="222" valign="top">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
												  ...
												  <? if($Row['bust']!=''){?>
												  <tr>
													<td align="left"><strong>Bust</strong>:</td>
													<td align="left"><? echo (stripslashes($Row['bust']));?></td>
												  </tr>
												  <? } ?>
												  <? if($Row['hips']!=''){?>
												  <tr>
												  ...
												  <? } ?>
												  <tr>
													<td align="left" colspan="2"><br><a href="editprofile.php" style="float:none;" class="button1"  >Edit Profile</a> &nbsp;<a href="logout.php" style="float:none;" class="button1"  >Logout</a><br><br></td>
												  </tr>
												</table>
											</td>
										  </tr>
							...
							<section class="col1_1 pad_left1" >
								...
								<div class="pad_bot1"><figure>
									<table width="100%" border="0" cellspacing="2" cellpadding="3">
									  ...
									  <tr><td align="left" style="padding:5px;"><a href="uploadpics.php" style="float:none;" class="button1" >Upload Pictures</a><br><br></td></tr>
									</table>
								</figure></div>
							</section>
						</div></div>
							...
							<section class="col1_1" >
								...
								<figure>
									<table width="100%" border="0" cellspacing="2" cellpadding="3">
												...
												<?
													...
													if($TotGetTotalPicture>0)
													{
														for($F=0;$F<$TotGetTotalPicture;$F++)
														{
															...
															?>
															  <tr>
																<td align='left' ><span style="padding-left:22px;background:url('images/marker_1.gif') 0 2px no-repeat">&nbsp;</span><a href="#" onClick="javascript:window.open('user_music.php?id=<?=$GetTotalMusicQryRow['id'];?>&userid=<?=$_SESSION['UsErId'];?>', '','width=650,height=500');return false;" ><? if($GetTotalMusicQryRow['caption']!=''){?><? echo ucfirst(stripslashes($GetTotalMusicQryRow['caption']));?><? }else{?>Music File<? }?></a></td>
									  ...
									  <tr><td align="left" style="padding:5px;"><a href="uploadmusic.php" style="float:none;" class="button1" >Upload Music</a><br><br></td></tr>
									</table>
								</figure></div>
								...
								<div class="pad_bot1">
									<figure>
										<table width="100%" border="0" cellspacing="2" cellpadding="3">
													...
													<?
														...
														if($TotGetTotalVideo>0)
														{
															for($F=0;$F<$TotGetTotalVideo;$F++)
															{
																...
																?>
																  <tr>
																	<td align='left' ><span style="padding-left:22px;background:url('images/marker_1.gif') 0 2px no-repeat">&nbsp;</span><a href="#" onClick="javascript:window.open('user_videos.php?id=<?=$GetTotalVideoQryRow['id'];?>&userid=<?=$_SESSION['UsErId'];?>', '','width=650,height=500');return false;" ><? if($GetTotalVideoQryRow['caption']!=''){?><? echo ucfirst(stripslashes($GetTotalVideoQryRow['caption']));?><? }else{?>Video File<? }?></a></td>
										  ...
										  <tr><td align="left" style="padding:5px;"><a href="uploadvideo.php" style="float:none;" class="button1"  >Upload Video</a><br><br></td></tr>
										</table>
									</figure>
								</div>
							</section>
								...
								<figure>
									<table width="100%" border="0" cellspacing="2" cellpadding="3">
									  <tr>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<?
													$GetTotalMusicQry="SELECT * FROM events WHERE userid='".trim($_SESSION['UsErId'])."' order by id desc";
													$GetTotalMusicQryRs=mysql_query($GetTotalMusicQry);
													$TotGetTotalPicture=mysql_affected_rows();
													if($TotGetTotalPicture>0)
													{
														for($F=0;$F<$TotGetTotalPicture;$F++)
														{
															...
															?>
															  <tr>
																<td align='left' ><span style="padding-left:22px;background:url('images/marker_1.gif') 0 2px no-repeat">&nbsp;</span><a href="eventdetail.php?eventId=<? echo ucfirst(stripslashes($GetTotalMusicQryRow['id']));?>"><? if($GetTotalMusicQryRow['name']!=''){?><? echo ucfirst(stripslashes($GetTotalMusicQryRow['name']));?><? }else{?>Event Name<? }?></a></td>
									  ...
									  <tr><td align="left" style="padding:5px;"><a href="addevent_step1.php" style="float:none;" class="button1" >Add Event</a><br><br></td></tr>
									</table>
								</figure></div>
