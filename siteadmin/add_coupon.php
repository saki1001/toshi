        ...
        <TBODY >
          <tr>
            ...
            <td width="80%" valign="top" align="center"><TABLE width="100%"  border=0 cellpadding="2" cellspacing="2">
                <TR>
                  <TD height="35" class=form111><? echo $Buttitle;?> Promotional Coupon </TD>
                </TR>
                <tr>
                  <td height="222" class="formbg" valign="top"><form name="addprod"  method=post enctype="multipart/form-data">
                      <TABLE cellSpacing=2 cellPadding=2 width=98% border=0 class="t-b">
                        ...
                        <TR>
                          <TD width="25%" height="25" align=right vAlign=top><strong><span class="a">*</span> Coupon Code:&nbsp;</strong></TD>
                        ...
                        <TR>
                          <TD width="25%" height="25" align=right vAlign=top><strong>Discount Type:&nbsp;</strong></TD>
                        ...
                        <TR>
                          <TD width="25%" height="25" align=right vAlign=top><strong><span class="a">*</span> Discount:&nbsp;</strong></TD>
						...
						<TR>
                          <TD width="25%" height="25" align=right vAlign=top><strong>Notes:&nbsp;</strong></TD>
                        ...
                        <TR>
                          <TD align=right>&nbsp;</TD>
                          <TD width="75%" colspan="3"><INPUT type=submit name="Submit" value="<? echo $Buttitle;?> Promotional Coupon" onClick="return valid();" class="bttn-s">
                          </TD>
                        </TR>
