...
if($_REQUEST['Did']>0)
{
	...
	$delpuic=mysql_query("delete from users_musics where id='$Did'");
	header("location:user_musics.php?msg=Your music has been deleted successfully.&id=".$_REQUEST['id']."");			
	exit;
}
...
<TABLE cellSpacing=10 cellPadding=0  border=0 width="98%" align="center">
	<TBODY>
		<TR>
		  <TD width="100%" class="form_back" height="25"><span class="form111"><? echo ucfirst(stripslashes($geti->firstname)." ".stripslashes($geti->lastname)); ?>'s Musics</span></TD>
		</TR>
						...
						<tr>
						  <TD align="center" colspan="2">
						  		<table width="100%"border="0" cellspacing="5" cellpadding="0">
									<?
										$GetTotalPictureQry="SELECT * FROM users_musics WHERE userid='".trim($id)."' order by id desc";
											...
											for($F=0;$F<$TotGetTotalPicture;$F++)
											{
												...
												<td width="250" height="155" valign="top" >
													<table border='0' cellpadding='0' cellspacing='0'  width="250" style="background-color:#999999;" >
													  ...
													  <tr>
														<td align='center' height="25" valign="bottom" ><a  href='#' class="button1" style="float:none;font-size:11px;" onClick="javascript:document.location.href='user_musics.php?Did=<? echo $GetTotalPictureQryRow['id']; ?>&id=<? echo $_REQUEST['id']; ?>';">Delete</a></td>
													  </tr>	
													</table>
												  </td>
												<?
