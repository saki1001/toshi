...
{	
	$cid=$_GET["id"];
	$dqry="delete from event_venues where id=$cid";
	mysql_query($dqry);	
	header("location:manage_eventvenue.php?msgs=2&start=".$_GET['start']."");
	exit;
}

$order=$_GET["order"];
$strQueryPerPage="select * from  event_venues where name like '$order%' $AndQry order by name asc";
...
{
	$Message2 = "Event Venue Added Successfully!!";
}
if($_GET["msgs"]==3 && !$_GET["start"])
{
	$Message2 = "Event Venue Updated Successfully!!";
}
if($_GET["msgs"]==15 && !$_GET["start"])
{
	$Message2 = "Event Venue Deleted Successfully!!";
}
?>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="80%" valign="top"><table width="100%"  border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td width="100%" height="35" class=form111>Manage Event Venue </td>
          </tr>
          <tr>
            <td align="center"  class="formbg"><table width="100%"  border="0" cellPadding="0" cellSpacing="0" align="left">
                ...
                <td valign="top"><table cellSpacing="0" cellPadding="1" border="0"  >
                      <tbody>
                        <tr>
                          <td colspan="25" height="20"><b>View By Event Venue Name </b></td>
                        </tr>
                        <?=$prs_pageing->order();?>
                      </tbody>
                    </table>
                    ...
                    <table width="70%" border="0"   cellspacing="1" cellpadding="1" align="center" >
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="t-a2">
                            <tr>
                              <td class=th-a><div align="center" ><strong>No Event Venue To Display</strong></div></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table>
                    ...
                    <form id="passionmanage" name="passionmanage"  method="post" action="#" enctype="multipart/form-data">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="t-b">
                        <tbody>
                          ...
                          <tr class="form_back" >
                            <td width="27%" height="20"  align="left"><strong>Event Venue</strong></td>
							<td width="21%" height="20"  align="left"><strong>Address</strong></td>
							<td width="18%" height="20"  align="left"><strong>City</strong></td>
							<td width="10%" height="20"  align="left"><strong>State</strong></td>
							<td width="12%" height="20"  align="left"><strong>Type</strong></td>
                          ...
                          <tr>
							...
							<td align="left"><? echo dcd($row->address); ?></td>
							<td align="left"><? echo dcd($row->city); ?></td>
							<td align="left"><? echo dcd($row->state); ?></td>
							<td align="left"><? echo dcd($row->status); ?>&nbsp;</td>
							<td  align="center" nowrap="nowrap">
							  <input name="button" type="button" onClick="window.location.href='add_eventvenue.php?id=<?php echo $row->id; ?>'" value=" Edit " class="bttn-s">
                              <input name="button2" type="button" onClick="deleteconfirm('Are you sure you want to delete <? echo dcd($row->name); ?>?. \n','manage_eventvenue.php?id=<?php echo($row->id); ?>');" value="Delete" class="bttn-s">
