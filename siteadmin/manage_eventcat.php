...
{	
	$cid=$_GET["id"];
	$dqry="delete from event_category where id=$cid";
	mysql_query($dqry);	
	header("location:manage_eventcat.php?msgs=2&start=".$_GET['start']."");
	exit;
}

$order=$_GET["order"];
$strQueryPerPage="select * from  event_category where name like '$order%' $AndQry order by name asc";
...
{
	$Message2 = "Event Category Added Successfully!!";
}
if($_GET["msgs"]==3 && !$_GET["start"])
{
	$Message2 = "Event Category Updated Successfully!!";
}
if($_GET["msgs"]==15 && !$_GET["start"])
{
	$Message2 = "Event Category Deleted Successfully!!";
}
?>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="80%" valign="top"><table width="100%"  border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td width="100%" height="35" class=form111>Manage Event Category </td>
          </tr>
          <tr>
            <td align="center"  class="formbg"><table width="100%"  border="0" cellPadding="0" cellSpacing="0" align="left">
                ...
                <td valign="top"><table cellSpacing="0" cellPadding="1" border="0"  >
                      <tbody>
                        <tr>
                          <td colspan="25" height="20"><b>View By Event Category Name </b></td>
                        </tr>
                        <?=$prs_pageing->order();?>
                      </tbody>
                    </table>
                    ...
                    <table width="70%" border="0"   cellspacing="1" cellpadding="1" align="center" >
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="t-a2">
                            <tr>
                              <td class=th-a><div align="center" ><strong>No Event Category To Display</strong></div></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table>
                    ...
                    <form id="passionmanage" name="passionmanage"  method="post" action="#" enctype="multipart/form-data">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="t-b">
                        <tbody>
                          ...
                          <tr class="form_back" >
                            <td width="81%" height="20"  align="left"><strong>Event Category</strong></td>
                          ...
                          <tr>
							...
							<td  align="center" width="19%" >&nbsp;
							  <input name="button" type="button" onClick="window.location.href='add_eventcat.php?id=<?php echo $row->id; ?>'" value=" Edit " class="bttn-s">
                              <input name="button2" type="button" onClick="deleteconfirm('Are you sure you want to delete <? echo dcd($row->name); ?>?. \n','manage_eventcat.php?id=<?php echo($row->id); ?>');" value="Delete" class="bttn-s">
