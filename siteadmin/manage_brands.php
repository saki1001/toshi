...
{	
	$cid=$_GET["id"];
	$dqry="delete from brands where id=$cid";
	mysql_query($dqry);	
	header("location:manage_brands.php?msgs=2&start=".$_GET['start']."");
	exit;
}

$order=$_GET["order"];
$strQueryPerPage="select * from  brands where name like '$order%' $AndQry  order by name asc";
...
{
	$Message2 = "Brand Added Successfully!!";
}
if($_GET["msgs"]==3 && !$_GET["start"])
{
	$Message2 = "Brand Updated Successfully!!";
}
if($_GET["msgs"]==15 && !$_GET["start"])
{
	$Message2 = "Brand Deleted Successfully!!";
}
?>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="80%" valign="top"><table width="100%"  border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td width="100%" height="35" class=form111>Manage Main Brand </td>
          </tr>
          <tr>
            <td align="center"  class="formbg"><table width="100%"  border="0" cellPadding="0" cellSpacing="0" align="left">
                ...
                <td valign="top"><table cellSpacing="0" cellPadding="1" border="0"  >
                      <tbody>
                        <tr>
                          <td colspan="25" height="20"><b>View By Brand Name </b></td>
                        </tr>
                        <?=$prs_pageing->order();?>
                      </tbody>
                    </table>
                    ...
                    <table width="70%" border="0"   cellspacing="1" cellpadding="1" align="center" >
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="t-a2">
                            <tr>
                              <td class=th-a><div align="center" ><strong>No Brand To Display</strong></div></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table>
                    ...
                    <form id="passionmanage" name="passionmanage"  method="post" action="#" enctype="multipart/form-data">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="t-b">
                        <tbody>
                          ...
                          <tr class="form_back" >
                            <td width="81%" height="20"  align="left"><strong>Brand</strong></td>
                          ...
                          <tr>
							...
							<td  align="center" width="19%" >&nbsp;
							  <input name="button" type="button" onClick="window.location.href='add_brand.php?id=<?php echo $row->id; ?>'" value=" Edit " class="bttn-s">
                              <input name="button2" type="button" onClick="deleteconfirm('Are you sure you want to delete Brand <? echo dcd($row->type); ?>?. \n','manage_brands.php?id=<?php echo($row->id); ?>');" value="Delete" class="bttn-s">
