...
{	
	$cid=$_GET["id"];
	$dqry="delete from genre where id=$cid";
	mysql_query($dqry);	
	header("location:manage_genre.php?msgs=2&start=".$_GET['start']."");
	exit;
}

$order=$_GET["order"];
$strQueryPerPage="select * from  genre where name like '$order%' $AndQry order by name asc";
...
{
	$Message2 = "Genre Added Successfully!!";
}
if($_GET["msgs"]==3 && !$_GET["start"])
{
	$Message2 = "Genre Updated Successfully!!";
}
if($_GET["msgs"]==15 && !$_GET["start"])
{
	$Message2 = "Genre Deleted Successfully!!";
}
?>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="80%" valign="top"><table width="100%"  border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td width="100%" height="35" class=form111>Manage Genre </td>
          </tr>
          <tr>
            <td align="center"  class="formbg"><table width="100%"  border="0" cellPadding="0" cellSpacing="0" align="left">
                ...
                <td valign="top"><table cellSpacing="0" cellPadding="1" border="0"  >
                      <tbody>
                        <tr>
                          <td colspan="25" height="20"><b>View By Genre Name </b></td>
                        </tr>
                        <?=$prs_pageing->order();?>
                      </tbody>
                    </table>
                    ...
                    <table width="70%" border="0"   cellspacing="1" cellpadding="1" align="center" >
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="t-a2">
                            <tr>
                              <td class=th-a><div align="center" ><strong>No Genre To Display</strong></div></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table>
                    ...
                    <form id="passionmanage" name="passionmanage"  method="post" action="#" enctype="multipart/form-data">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="t-b">
                        <tbody>
                          ...
                          <tr class="form_back" >
                            <td width="81%" height="20"  align="left"><strong>Genre</strong></td>
